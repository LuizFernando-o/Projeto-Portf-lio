        ...
        <div class="col">
            <div class="card" style="width: 18rem;">
                ...
                <div class="card-body">
                    ...
                    <a target="blank" href="curriculoIndex.php?pg=music" class="btn btn-primary">Visitar</a>
                </div>
            </div>
        ...
        <div class="col">
            <div class="card" style="width: 18rem;">
                ...
                <div class="card-body">
                    ...
                    <a target="blank" href="curriculoIndex.php?pg=global" class="btn btn-primary">Visitar</a>
                </div>
            </div>
